  ...
  _createClass(CountdownTimer, [{
    ...
    value: function start() {
      ...
      setInterval(function () {
        ...
        var time = _this.targetDate - currentTime;

        var timeSecs = _this.getTimeComponents(time);

        _this.updateClockface(timeSecs);
      }, 1000);
    } // оновлюємо числа на циферблату

  }, {
    key: "updateClockface",
    value: function updateClockface(_ref2) {
      var days = _ref2.days,
          hours = _ref2.hours,
          mins = _ref2.mins,
          secs = _ref2.secs;
      var timerId = document.querySelector(this.selector);
      var daysId = timerId.querySelector('span[data-value="days"]');
      var hoursId = timerId.querySelector('span[data-value="hours"]');
      var minsId = timerId.querySelector('span[data-value="mins"]');
      var secsId = timerId.querySelector('span[data-value="secs"]');
      daysId.textContent = "".concat(days);
      hoursId.textContent = "".concat(hours);
      minsId.textContent = "".concat(mins);
      secsId.textContent = "".concat(secs);
